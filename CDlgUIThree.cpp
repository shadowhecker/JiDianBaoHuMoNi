...
CDlgUIThree::~CDlgUIThree()
{
}

void CDlgUIThree::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgUIThree, CDialogEx)
END_MESSAGE_MAP()
...
void CDlgUIThree::UpdateUIInput()
{
	UpdateData(TRUE);
	InputUData();
	InputIData();
